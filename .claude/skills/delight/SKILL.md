...
**References to read**: `../ui-craft/references/motion.md` (Decision Ladder + interaction rules) and `../ui-craft/references/copy.md` (microcopy voice). For multi-stage motion, write a short state-by-state storyboard before implementation.
