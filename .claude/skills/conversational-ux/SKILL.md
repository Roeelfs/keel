...
description: Design voice and conversational interfaces — dialog flows, error recovery, and persona. Use when the interface speaks and listens rather than being tapped. For graphical input collection, pair with `interaction-design` and the form guidance in `ui-craft`.
---
# Conversational UX
