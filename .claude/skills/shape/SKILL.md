...
**Step 4 — State list.** Enumerate the states this screen must handle. Point at [../ui-craft/references/state-design.md](../ui-craft/references/state-design.md) for the contracts.
...
- **User confirms →** format the output as a `## Surface: <name>` section following the template in `../ui-craft/references/spec.md`, then write or append to `.ui-craft/spec.md`. Confirm in one line: "Written to `.ui-craft/spec.md` → `## Surface: <name>`."
